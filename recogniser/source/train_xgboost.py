...
# If your labels are strings, you might need to encode them first, e.g., using sklearn.preprocessing.LabelEncoder
# For example:
# from sklearn.preprocessing import LabelEncoder
# le = LabelEncoder()
# labels = le.fit_transform(labels)
# joblib.dump(le, "label_encoder.pkl") # Save the encoder if you need to reverse transform later
...
try:
    ...
    sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', cbar=False,
                xticklabels=['Predicted 0', 'Predicted 1'], # Adjust labels if multi-class
                yticklabels=['Actual 0', 'Actual 1'])     # Adjust labels if multi-class
...
# Note: XGBoost models typically don't have a direct 'label_encoder' attribute like some custom models.
# If you used a LabelEncoder to transform string labels to integers, save that encoder separately.
