...
# from setup.decisiontree import load_model
# MODEL_PATH = 'saved_models/decision_tree_model.pkl'

# from setup.randomforest import load_model
# MODEL_PATH = 'saved_models/random_forest_model.pkl'

from setup.xgboost import load_model
...
try:
    RECOGNITION_MODEL, LABEL_ENCODER = load_model(MODEL_PATH, LABEL_ENCODER_PATH)
...
async def websocket_handler(websocket):
    ...
    try:
        async for message in websocket:
            ...
            predicted_label_encoded_np = RECOGNITION_MODEL.predict(prediction_input)[0] # This will be np.int64
            predicted_probabilities_np = RECOGNITION_MODEL.predict_proba(prediction_input)[0] # This will be np.ndarray of floats
